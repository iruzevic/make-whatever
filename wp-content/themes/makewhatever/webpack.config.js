...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'https://make-whatever.test', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/makewhatever', // Project path relative to project root.
		},
	};
