...
namespace Makewhatever\Columns\Media;

use MakewhateverVendor\EightshiftLibs\Columns\Media\AbstractMediaColumns;
...
class WebPMediaColumn extends AbstractMediaColumns
{
	...
	{
		$columns[self::COLUMN_KEY] = \esc_html__('WebP', 'makewhatever');
		return $columns;
	}
