 ...
 *
 * @package Makewhatever\Rest\Routes\LoadMore
 */

declare(strict_types=1);

namespace Makewhatever\Rest\Routes\LoadMore;

use Makewhatever\Config\Config;
use MakewhateverVendor\EightshiftLibs\Helpers\Helpers;
use MakewhateverVendor\EightshiftLibs\Rest\CallableRouteInterface;
use MakewhateverVendor\EightshiftLibs\Rest\Routes\AbstractRoute;
use WP_Error;
use WP_Query;
use WP_REST_Request;
 ...
 * Class LoadMoreRoute
 */
final class LoadMoreRoute extends AbstractRoute implements CallableRouteInterface
{
	/**
	 * Route name constant.
	 *
