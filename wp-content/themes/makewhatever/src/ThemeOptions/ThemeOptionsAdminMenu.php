 ...
 *
 * @package Makewhatever\ThemeOptions
 */

declare(strict_types=1);

namespace Makewhatever\ThemeOptions;

use MakewhateverVendor\EightshiftLibs\AdminMenus\AbstractAdminMenu;

/**
 * ThemeOptionsAdminMenu class.
 */
class ThemeOptionsAdminMenu extends AbstractAdminMenu
{
	/**
	 ...
	 * @var string
	 */
	public const ADMIN_MENU_SLUG = 'es-theme-options';
	...
	{
		return \esc_html__('Theme options', 'makewhatever');
	}
	...
	protected function getIcon(): string
	{
		...
		if (\str_starts_with(self::ADMIN_MENU_ICON, '<svg')) {
	...
	{
		return [
			'pageTitle' => \esc_html__('Theme options', 'makewhatever'),
		];
	}
}
