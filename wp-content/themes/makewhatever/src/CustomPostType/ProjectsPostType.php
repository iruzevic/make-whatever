...
/**
 * File that holds class for ProjectsPostType custom post type registration.
 *
...
class ProjectsPostType extends AbstractPostType
{
	 ...
	 * @var string
	 */
	public const POST_TYPE_SLUG = 'projekti';
	 ...
	 * @var string
	 */
	public const POST_TYPE_URL_SLUG = 'projekti';
	 ...
	 * @var string
	 */
	public const REST_API_ENDPOINT_SLUG = 'projekti';
