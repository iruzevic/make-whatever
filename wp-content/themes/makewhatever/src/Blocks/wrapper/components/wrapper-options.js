...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	const {
		label = __('Spacing & layout', 'makewhatever'),
		showWrapperId = true,
	...
	let wrapperUseOptions = [
		{
			label: __('Just the block', 'makewhatever'),
			value: 'off',
	...
	if (wrapperSimpleShowControl) {
		wrapperUseOptions = [...wrapperUseOptions, {
			label: __('Spacing only', 'makewhatever'),
			value: 'simple',
					...
					{!wrapperNoControls && wrapperUseShowControl &&
						<div className='es-display-flex es-items-center es-gap-1 es-ml-auto es-flex-shrink-0 es-mr-1 es-wrapper-options-copy-paste'>
							<Button
								...
								label={__('Copy configuration', 'makewhatever')}
								showTooltip
							/>
							...
							<Button
								...
								className='es-button-icon-24 es-button-square-24 es-rounded-0.75!'
								label={__('Paste configuration', 'makewhatever')}
								showTooltip
							/>
						</div>
					}
			...
			{wrapperUse &&
				<>
					...
					{wrapperUse && showWrapperTag &&
						<OptionSelector
							label={__('Wrapper tag', 'makewhatever')}
							icon={icons.code}
					...
					>
						...
						{(!noLeftSpacingInSelector || !noRightSpacingSelector) &&
							<Collapsable label={__('More', 'makewhatever')} icon={icons.moreH}>
								{!noLeftSpacingSelector &&
									<ResponsiveNumberPicker
										icon={icons.spacingLeft}
										label={__('Left', 'makewhatever')}
						...
						{showWrapperSpacingTopIn &&
							<ResponsiveNumberPicker
								...
								label={__('Top inner', 'makewhatever')}
						...
						{showWrapperSpacingBottomIn &&
							<ResponsiveNumberPicker
								...
								label={__('Bottom inner', 'makewhatever')}
						...
						{(!noLeftSpacingInSelector || !noRightSpacingInSelector) &&
							<Collapsable label={__('More', 'makewhatever')} icon={icons.moreH} noBottomSpacing>
								{!noLeftSpacingInSelector &&
									<ResponsiveNumberPicker
										icon={icons.spacingLeftIn}
										label={__('Left inner', 'makewhatever')}
								...
								{!noRightSpacingInSelector &&
									<ResponsiveNumberPicker
										...
										label={__('Right inner', 'makewhatever')}
					...
					>
						{showWrapperBgColorPicker &&
							<AdvancedColorPicker
								...
								pickerPopupTitle={__('Background', 'makewhatever')}
								groupShades
								canReset
								...
								types={
									[
										{
											label: __('None', 'makewhatever'),
											value: '',
											icon: icons.emptyCircle,
										},
										{
											label: __('Project color', 'makewhatever'),
											value: 'project',
											icon: icons.colorAlt,
										},
										{
											label: __('Gradient', 'makewhatever'),
											value: 'gradient',
											icon: icons.gradient,
										}
									]
						...
						{(showWrapperDividerTop || showWrapperDividerBottom || showWrapperDividerLeft || showWrapperDividerRight || showWrapperDividerColor) &&
							...
							>
								{showWrapperDividerColor &&
									<ColorPicker
										colors={[{ name: __('None', 'makewhatever'), slug: undefined, color: 'transparent' }, ...dividerColors]}
										...
										pickerPopupTitle={__('Divider color', 'makewhatever')}
											...
											{breakpointNames.map((breakpoint, index) => {
												...
												return (
													<Button
														...
														label={attributeValue ? __('On', 'makewhatever') : __('Off', 'makewhatever')}
														showTooltip
													/>
												);
											})}
					...
					<Section
						...
						subtitle={__('Visibility, anchor, ID', 'makewhatever')}
						noBottomSpacing
						collapsable
					>
						{showWrapperHide &&
						...
						{showWrapperAnchorId &&
							<TextControl
								label={<IconLabel icon={icons.anchor} label={__('Block Anchor ID', 'makewhatever')} />}
						...
						{showWrapperId &&
							<TextControl
								label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'makewhatever')} />}
								value={wrapperId}
