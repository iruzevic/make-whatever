	...
	return (
		<>
			<Responsive
				...
				label={__('Placement', 'makewhatever')}
				...
				{({ breakpoint }) => {
					...
					return (
						<ColumnConfigSlider
							...
							aria-label={sprintf(__('Column: width and offset - %s', 'makewhatever'), breakpoint)}
						/>
					);
				}}
			</Responsive>
			...
			<Responsive
				...
				label={__('Row span', 'makewhatever')}
				options={generateOptionsFromValue(columnRowSpan, (v) => (!v ? __('Not set', 'makewhatever') : sprintf(_n('1 row', '%d rows', v, 'makewhatever'), v)))}
				noModeSelect
				inline
				{...responsiveData}
			>
				{({ currentValue, handleChange, breakpoint }) => (
					<NumberPicker
						...
						max={12}
						step={1}
						aria-label={sprintf(__('Column: row span - %s', 'makewhatever'), breakpoint)}
						size='small'
						fixedWidth={2.5}
						placeholder='–'
					/>
			...
			<Spacer
				...
				text={__('Content alignment', 'makewhatever')}
				border
			/>
			...
			<Responsive
				...
				label={__('Horizontal', 'makewhatever')}
			...
			>
				{({ currentValue, handleChange, options, isInlineCollapsedView, breakpoint }) => (
					<OptionSelect
						...
						noTriggerLabel
						aria-label={sprintf(__('Column: content horizontal align - %s', 'makewhatever'), breakpoint)}
					/>
				)}
			</Responsive>
			...
			<Responsive
				...
				label={__('Vertical', 'makewhatever')}
			...
			>
				{({ currentValue, handleChange, options, isInlineCollapsedView, breakpoint }) => (
					<OptionSelect
						...
						noItemIcon={!isInlineCollapsedView}
						noTriggerLabel
						aria-label={sprintf(__('Column: content vertical align - %s', 'makewhatever'), breakpoint)}
					/>
				)}
			</Responsive>
			...
			<ColorPicker
				...
				value={columnBorder}
				aria-label={__('Border', 'makewhatever')}
				clearable
				inline
			/>
			...
			<OptionSelect
				...
				aria-label={__('Shadow', 'makewhatever')}
				type='menu'
				inline
			/>
			...
			>
				{({ currentValue, handleChange, options, isInlineCollapsedView, breakpoint }) => (
					<OptionSelect
						...
						noItemIcon={!isInlineCollapsedView}
						aria-label={sprintf(__('Column: visibility - %s', 'makewhatever'), breakpoint)}
					/>
				)}
			</Responsive>
			...
			<Responsive
				...
				label={__('Content overflow', 'makewhatever')}
			...
			>
				{({ currentValue, handleChange, options, breakpoint }) => (
					<OptionSelect
						...
						value={String(currentValue)}
						onChange={(value) => handleChange(value)}
						aria-label={sprintf(__('Column: content overflow - %s', 'makewhatever'), breakpoint)}
						type='menu'
					/>
				)}
			</Responsive>
