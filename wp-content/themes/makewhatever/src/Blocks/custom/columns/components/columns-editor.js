		...
		<>
			{innerBlockCount < 1 && (
				<div className='es-uic-font-sans mx-auto grid max-w-72 grid-cols-2 gap-1.5 rounded-lg border border-gray-200 p-3 text-xs shadow-lg'>
					...
					<span className='col-span-2 select-none justify-self-center'>{__('Common layouts', 'makewhatever')}</span>
					...
					<span className='col-span-2 select-none justify-self-center'>{__('or', 'makewhatever')}</span>
