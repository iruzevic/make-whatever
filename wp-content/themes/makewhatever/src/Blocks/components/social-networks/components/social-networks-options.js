...
export const SocialNetworksOptions = (attributes) => {
	...
	const modeOptions = [
		...
		{
			label: __('Share to social networks', 'makewhatever'),
			icon: icons.share,
			value: true,
		}
	];

	const pickerSectionTitle = socialNetworksShareMode ? __('Share targets', 'makewhatever') : __('Social networks', 'makewhatever');
